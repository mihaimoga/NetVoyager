...
***Ask not what NetVoyager can do for you - ask what you can do for NetVoyager***
...
2. Include additional information such as:
    ...
    * NetVoyager Debug-Info containing:
...
1. Respect existing NetVoyager coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
